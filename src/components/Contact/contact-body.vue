    ...
    <div class="alpha">
      ...
      <div class="contact-text">
        ...
        <div style="margin-bottom: 4%">
          <h2 class="contact-text-header-3">DDB Headquarters</h2>
          <p class="contact-text-para-2">
            N 3050, Key West Street &,
...
<!--          <p class="contact-text-para-3">Telephone: +1 (242) 366-7764</p>-->
        ...
        <div>
          <h2 class="contact-text-header-3">DDB Digital Branch</h2>
          <p class="contact-text-para-2">
...
.subscribe-wrapper:after {
  ...
  border-bottom: 10px solid #01675b;
}
...
.subscribe-wrapper input:focus {
  outline: none;
  border-bottom: 1px solid #01675b;
}
