    ...
    <div class="form-alpha">
      <form >
        ...
        <div class="has-addons">
          ...
          <input @input="validatePassword" v-if="showPassword"    type="text" class="input-form-1 password"   placeholder="Create Passcode" />
          <input @input="validatePassword" v-else type="password"   class="input-form-1  password"  placeholder="Create Passcode"   >
