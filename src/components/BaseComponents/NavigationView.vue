          ...
          <li class="link">
            <div class="dropdown-navigation" @click="toggleDropdown">
              ...
              <div v-if="showDropdown" class="dropdown-content">
                ...
                <router-link  to="/iraview">IRA Account <i class='bx bxs-chevron-right'></i></router-link>
              </div>
            </div>
          </li>
          ...
          <li class="link">
            <div class="dropdown-navigation" @click="toggleDropdown">
              ...
              <div v-if="showDropdown" class="dropdown-content">
                ...
                <router-link  to="/mortgagesView">Mortgages<i class='bx bxs-chevron-right'></i></router-link>
                <router-link  to="/studentLoan">Student Loan<i class='bx bxs-chevron-right'></i></router-link>
              </div>
            </div>
          </li>
        ...
        <div>
          <ul class="dropdown-nav" v-show="mobileNav">
            ...
            <label class="accordion-wrapper">
              ...
              <div class="content" >
                <div class="title-content content-2">
                  <router-link to="/about"><p @click="toggleMobileNav2" class="title-content-para">About DDB</p></router-link>
                </div>
              </div>
