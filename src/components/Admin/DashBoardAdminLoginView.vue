<template>
  <div class="alpha">
    ...
    <div class="text-area">
      <h3>Log in to your Admin account</h3>
    ...
    <div class="form-alpha">
      <form >
        ...
        <div class="has-addons">
          <input v-if="showPassword2"  required="required"  type="text" class="input-form-1 password"   placeholder="Enter password"   />
          <input v-else type="password"  required="required" class="input-form-1  password"   placeholder="Enter password"   >
          <div class="space">
