  ...
  <div class="outer">
    ...
    <div class="sidebar" v-show="!mobile">
      ...
      <ul class="nav-list" >
        ...
        <router-link to="/add-new-account">
          <li>
            <a class="hover">
              <img src="../../assets/walletmana.svg" alt="logo" class="link-img" />
              <span class="links-name wallets">Add Account</span>
            </a>
          </li>
        </router-link>
        ...
        <router-link to="/investments-list">
          <li>
            <a class="hover">
              ...
              <span class="links-name">Balance</span>
            </a>
          </li>
        </router-link>
...
<!--          </li>-->
<!--        </router-link>-->
<!--        <router-link to="/edit-loan">-->
<!--          <li>-->
<!--            <a class="hover">-->
<!--              <img src="../../assets/walletmana.svg" alt="logo" class="link-img" />-->
<!--              <span class="links-name">Edit Loan</span>-->
<!--            </a>-->
<!--          </li>-->
<!--        </router-link>-->
<!--        <router-link to="/edit-investments">-->
<!--          <li>-->
<!--            <a class="hover">-->
<!--              <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />-->
<!--              <span class="links-name">Edit Investments</span>-->
<!--            </a>-->
<!--          </li>-->
<!--        </router-link>-->
...
import DashContent2 from "@/components/BaseComponents/DashContent2.vue";
